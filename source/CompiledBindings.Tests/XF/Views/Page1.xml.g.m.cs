...
#line (42, 13) - (42, 58) 42 "Page1.xml"
				var value1 = dataRoot.BooleanProp;
#line (41, 13) - (41, 39) 41 "Page1.xml"
				var value2 = dataRoot.DecimalProp;
#line (46, 16) - (46, 54) 46 "Page1.xml"
				var value3 = dataRoot.ListProp;
#line (44, 16) - (44, 51) 44 "Page1.xml"
...
#line (72, 16) - (72, 65) 72 "Page1.xml"
				targetRoot.label12.Text = $"{value1} and {value2}";
#line default
...
#line (72, 16) - (72, 65) 72 "Page1.xml"
						targetRoot.label12.Text = $"{dataRoot.BooleanProp} and {value1}";
#line default
						if (!notifyAll)
						{
							return;
...
#line (72, 16) - (72, 65) 72 "Page1.xml"
						targetRoot.label12.Text = $"{value1} and {dataRoot.DecimalProp}";
#line default
						if (!notifyAll)
						{
							return;
